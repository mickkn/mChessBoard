"""
    This module implements the Minic class.
    :copyright: (c) 2021 by Mick Kirkegaard.
    :license: MIT, see LICENSE for more details.
    Re-written stockfish script from Ilya Zhelyabuzhsky's Stockfish
"""

import subprocess
from typing import Any, List, Optional

DEFAULT_MINIC_PARAMS = {
    "UCI_Chess960": "false",
}


class Minic:
    """Integrates the Minic chess engine with Python."""

    def __init__(
        self, path: str = "minic", depth: int = 2, parameters: dict = None
    ) -> None:
        ...
        self._stockfish_major_version: str = str(self._read_line().replace("info string This is Minic version ", ""))
        ...
        if parameters is None:
            parameters = {}
        self._parameters = DEFAULT_MINIC_PARAMS
    ...
    def get_parameters(self) -> dict:
        ...
        Returns: Dictionary of current Minic engine's parameters.
        """
